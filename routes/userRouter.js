...
router.get("/bookCardio",async(req,res)=>{
...
router.get("/bookPedi",async(req,res)=>{
...
router.get("/bookGyno",async(req,res)=>{
...
router.get("/bookNeuro",async(req,res)=>{
...
router.get("/bookGen",async(req,res)=>{
...
router.get("/bookedAppointments",async(req,res)=>{
    let patientId = req.query.patientId;
    book.find({patientId:patientId}).populate({path:'doctorId'}).then((result) => {
        res.send(result)
    });
});
